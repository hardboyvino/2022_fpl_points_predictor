...
def main():
    ...
    single_predict(pickling="Random Forest GK PerApp 3GWs.pkl", file="GK PerApp 3GWs.csv")
    single_predict(pickling="Random Forest DEF PerApp 2GWs.pkl", file="DEF PerApp 2GWs.csv")
    single_predict(pickling="Random Forest MID PerApp 6GWs.pkl", file="MID PerApp 6GWs.csv")
    single_predict(pickling="Random Forest FWD PerApp 5GWs.pkl", file="FWD PerApp 5GWs.csv")
    three_gw_predict(pickling="Random Forest 3Ahead GK PerStart 2GWs.pkl", file="GK PerStart 2GWs.csv")
    three_gw_predict(pickling="Random Forest 3Ahead DEF PerApp 5GWs.pkl", file="DEF PerApp 5GWs.csv")
    three_gw_predict(pickling="Random Forest 3Ahead MID PerApp 5GWs.pkl", file="MID PerApp 5GWs.csv")
    three_gw_predict(pickling="Random Forest 3Ahead FWD PerApp 6GWs.pkl", file="FWD PerApp 6GWs.csv")
