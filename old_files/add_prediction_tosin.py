"""
Add prediction for next GW and next 3 GWs based on Linear regression
...
def main():
    """Main function for Tosin's team prediction."""
    single_predict(pickling="Linear GK PerApp 6GWs.pkl", file="GK PerApp 6GWs.csv")
    single_predict(pickling="Linear DEF PerApp 5GWs.pkl", file="DEF PerApp 5GWs.csv")
    ...
    three_gw_predict(pickling="Linear 3Ahead GK PerApp 6GWs.pkl", file="GK PerApp 6GWs.csv")
    three_gw_predict(pickling="Linear 3Ahead DEF PerApp 5GWs.pkl", file="DEF PerApp 5GWs.csv")
    three_gw_predict(pickling="Linear 3Ahead MID PerApp 5GWs.pkl", file="MID PerApp 5GWs.csv")
    three_gw_predict(pickling="Linear 3Ahead FWD PerApp 6GWs.pkl", file="FWD PerApp 6GWs.csv")
