...
def main():
    ...
    join_predictions("Linear GK PerApp 6GWs 1Ahead.csv", "Linear GK PerApp 6GWs 3Ahead.csv")
    ...
    join_predictions("Linear FWD PerApp 6GWs 1Ahead.csv", "Linear FWD PerApp 6GWs 3Ahead.csv")
