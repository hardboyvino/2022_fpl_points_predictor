...
def main():
    ...
    join_predictions("Random MID PerApp 6GWs 1Ahead.csv", "Random MID PerApp 5GWs 3Ahead.csv")
    join_predictions("Random FWD PerApp 5GWs 1Ahead.csv", "Random FWD PerApp 6GWs 3Ahead.csv")
